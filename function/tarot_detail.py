...
class tarot(object):
    ...
    def __init__(self):
        self.class_name = 'tarot'
        
    def traot_multicard_3(self):
        tarot_content = self.tarot_random_get(3)
    ...
    def traot_multicard_5(self):
        tarot_content = self.tarot_random_get(5)
        carousel_template_message = TemplateSendMessage(
            alt_text='traot占卜結果',
            template=CarouselTemplate(
                columns=[
    ...
    def tarot_random(self):
        return self.tarot_detail(random.randint(0,155))    
    
    def tarot_random_get(self,res):
        tarot_list = []
        for obj in random.sample(range(156),res):
            tarot_list.append(self.tarot_detail(obj))
    
        return tarot_list   
    
    def tarot_detail(self,res):
    ...
    而在男女情感中出現積極主動、愛慾之情；而權杖也是一種植物，一種生命的展現，是一種發展的意志。\n\n\
    工作方面，此牌出現了強旺的生命力，代表著工作上的事情發展面向強烈，行動力的積極展現，往各個面向順暢擴展，生生自強不息。\
    牌面當中的城堡，象徵著成功，在正位之時，行動往成功的堡壘走去。\n\n\
    而權杖也代表著權力的象徵，在結構化的關係中，容易出現各種職掌位階的出現，比如現代的行政官僚體系當中有各種不同的職位，\
    其長處是具有強烈的目標與指導性，而其短處在於關係上的不平等；另權力也代表著交付的可能性，\
    ...
    失其溫度，喪失了趣味性，種種的無力。\n\n\
    工作的面向來說，充滿怠惰，各種的拖延，得過且過，沒有任何的衝勁，敷衍了事，萎靡不振。\n\n\
    ...
    我們得以調情的元素，是我們感情面的創造工具。\n\n\
    而ACE牌面的構圖為鴿子雕著聖餐進入滿溢的杯子中，叼著生命的愛進入杯中產生涓涓的流水，\
    這裡揭示了我們情感的來源乃是當我們處在一個生命狀況之下所產生的，願意積極的主動投入，相反的來說，\
    無法感受的人往往缺乏的便是對於自己生命的愛，不願用自己的心去創造體驗自己生命的種種與當下。\n\n\
    聖杯ACE是情感的初始，一種到來的新經驗，以構圖的面向來講，涓流與瀰矇的水霧譜出一種美，一種漫妙的情景，\
    本身來講並不喧騰，是一種和緩的情感面向，以男女之情來說，雙方都感到美好幸福，感到備受呵護，處在穩定正向的情感當中。\n\n\
    ...
    不願投入情感，無法活出自己。\n\n\
    在此狀態下，產生的是對於生命種種的煩，種種的無趣，煩躁感是此刻內心的體現，有種掙扎，在關係當中表現為冷漠與拒絕。\n\n\
    另外一方面也有可能是元素的過度氾濫，水元素的過度氾濫意味被情緒所牽引，感受無法控制，正向的情感創造面失去了，\
    成為一種受困於情緒當中的行為。\n\n\
    ...
    寶劍ACE的構圖為劍貫入一皇冠之中，皇冠象徵著是頭腦，想法係腦中產生(從皇冠中延伸而出不斷生長的植物亦代表想法不斷的出現)，\
    另皇冠意味著此穿過頭腦的劍具有榮耀的象徵，長處上是具有智慧與思考的能力，頭腦理智清晰，有決斷力，懂得選擇，\
    短處是想法往往具有排他的特性，想法與想法間往往不能互容，故刀劍相向，世人總是因想法不同而爭戰。\n\n\
    在人際關係當中，寶劍ACE正位，大家相互以理智作為相處之連接，常見的場景如辯論會場，工作會議場合，是一種意見的交換，\
    且寶劍具有切割的特性，故在相處中人-我邊界鮮明，雙方保有自己的想法與空間，彼此之間也鮮少過問私事，\
    另外台面上相處的事情是公開透明，凡事有理有據，條理分明，講求SOP，灰色空間模糊地帶是不允許存在的；\n\n\
    在感情方面，出現過多的寶劍牌組代表雙方皆於情感上有所保留，強調兩人之間如何相處，怎麼'配合'，\
    這種感情往往不怎樣浪漫，雙方多在談條件，而少有感情上的依偎；寶劍牌組在初始的關係中很難有愛的感覺，\
    ...
    又或者是沒有中心思想，在選擇當中無法決定，想法搖擺不定。\n\n\
    關係層面雙方可能因想法的不容大打出手，互相指責，彼此無法包容彼此間的差異，純槍舌戰，為了吵架而吵架，\
    非建設性的討論，只是要爭個輸贏。\n\n\
    ...
    在地上的土，是所有元素當中最為穩定的物質，不像其他的元素具有行動與流動，故土本身即為穩定的代表，出現金幣元素時，\
    請想到土地所能帶給你的感受，能讓你穩穩的立足於其上，能生長各種的作物與生命。\n\n\
    正位之時，手捧住元素本身，手緊密的脫握整個元素，除了得到錢財之外，亦代表著掌握金錢的流向脈絡，\
    投資方面掌握了大局，握有關鍵的賺錢要素，而豐沃的土地代表著投資環境的良好，得到環境的支持，坐擁有先天的優勢。\n\n\
    而關係層面上來說，正位之時代表經濟實力佳，有金錢作為後盾，雙方的關係在此基礎上穩定的發展，掌握滿足了生活的基本需求，\
    人際的經營以穩定的方式向前，穩健的步伐是關係的寫照；\n\n\
    從另外一方面來說，金幣代表一種投資與回饋，感情當中出現太多的金幣牌組有可能雙方的感情關係是以利益做為結盟的，\
    在情愛中所展現的是雙方的實際面向之種種，且這樣的愛情往往是求有回報。\n\n\
    ...
    大環境的不佳，風險的增加，也代表著投資失利，財富的流失，也有可能是投資的門路錯誤，造成金錢上的損失。\n\n\
    人際的關係上，可能雙方本身無法通過麵包的考驗，以財富作為基礎的關係此時難以通過考驗，經濟上的拮据使兩人之間無法維持，\
    ...
    故此副牌面來說，乃在於權力的擴張。\n\n\
    圖中，一根權杖已固定於城堡城牆上，表示已經有穩固的基礎，有一定的權位存在，在穩定的面向上，拿著地球，綜攬權局，\
    高瞻遠矚，想著未來的發展道路，可以是吞併對方，洽談併購事宜，或是談合作關係，延伸自己的權力。\n\n\
    感情發展的面向，已經達到了一個階段，準備將關係跨入更大的面向，彼此有這樣的想法；工作亦是如此，\
    ...
    整體來講是符合社會脈絡與支持的，然這些目標目仍非常遙遠，重點在於當下的情感接觸。\n\n\
    聖杯二是我們與理想當中的對象碰觸，與情愛的對象接觸，當對方有了回復，願意分享敞開，構築起兩人理想的世界，我們便戀愛了，\
    一段戀情便開始了。\n\n\
    此牌稱為小戀人牌，小戀人牌當中，繪製為初始的碰觸，感情初始的階段，戀情的開始，而大牌當中的戀人牌，\
    ...
    社交場合的談話，客套一下而已。\n\n\
    無法交換手中的水，表示封閉自己的內心，無法信任對方，甚至是交換無水的杯子，期間必然產生種種的不悅，\
    隔閡、衝突與糾紛於是產生。\n\n\
    ...
    處在一個拉扯之下，思想璇盪在兩者之間，而此情況當事人可能需要靜下來思考，傾聽內在的聲音，用自己的內心去體會兩者，\
    坐在冰冷的石椅上冷靜的面對自我。\n\n\
    在關係當中，雙方之間有意見上的不合，然該部分係被隱藏於台面之下，如同大海與礁岩所形成的暗流洶湧，\
    ...
    人際面向上，雙方的交流頻繁，然快速的更動疊代雙方難有體會彼此的機會，更多的是一種娛樂好玩或是緊湊的關係配合，\
    也有可能只是一種人際上的應付應付；又或者在感情上兩頭燒，可能有腳踏兩條船的高招技巧(背後也是兩條船)，而且還可以應付得來。\n\n\
    ...
    齊心協力，對於未來大家有共同的目標，並且朝著目標前進，而船隊的方向如果為回航的話，正位也代表令人滿意的成果。\n\n\
    在感情方面，雙方可能有一方提出新的計劃，有新的行動，跳脫目前生活模式，嚮往更積極豐富的生活，而兩人之間的生活協調順暢，\
    ...
    在一段大家的努力後獲得豐收的喜慶，比如達成共識簽約後的慶祝，來杯酒大家開心開心。\n\n\
    人際方面聖杯三代表相處愉快，大家是以感情層面的聯繫而成的團體，團體之間雖然沒有什麼目標，但是大家相處和諧，\
    ...
    另外逆位之聖杯三也代表可能無法達成共識，沒有共同的情感結合，大家聚在一起，雖然表面上是互相干杯，但是杯中卻無水，\
    也表示了人際之間只做表面形式，大家具在一起每個人或許意有它圖，當前看起來得愉快只是裝模作樣，私底下是另有盤算，\
    ...
    畢竟看主題就知道是傷心，而另外一方面，塔羅的活用來講，直觀的看見本張牌也想到如果有疾病的話，可能有心臟疾病。\n\n\
    ...
    而此張牌的態度是嚴謹的，是謹慎的態度面對下一步，整體的合作步調以穩健為主，且合作的角色之間權力較為對等，\
    與本張牌的土元素，最為穩定的元素符合，而同樣的權杖三也有合作之意，然權杖系火元素，具有熱度，\
    權杖三的合作更為偏向帶有一種熱烈，一種革命情感，且權杖具有權力的象徵，也代表合作關係當中有一位地位較高之指揮者\
    ；故在學習塔羅牌之時，雖然相同的關鍵字，然而花色元素的不同，也會造成牌義上的細微之差異，要有較為精緻的服務，\
    還需對各個元素與牌之理解有較為深刻之認識，只記關鍵字之學習塔羅牌之方式難免有粗糙之感。\n\n\
    在感情當中，雙方互有共同的目標，未了未來做努力，且雙方願意承擔自己在付諸雙方理相中的角色，願意主動承擔自己的位置，\
    ...
    大家愉快的慶祝。\n\n\
    四代表穩定，所以在權杖四中感情關係中屬於穩定的現象，而權杖是火元素，所以這個穩定要加一點火的元素與生命力在裡面，\
    穩定的成長關係，愛情的和緩發展，充滿了安全感；另外此張牌也是成家牌，前方的男女與整個場景的佈置與結婚場相似，\
    故也蘊含有婚姻跡象出現。\n\n\
    工作上興旺的結果，工作收穫成累累的結實。"
    ...
    故聖杯四是對於生活的一種評估，想要的是過什麼樣的生活；另外一方面也有可能有誘惑，想要體驗不同的生活，\
    然而只是在腦中想想而已，正位之時並沒有實際的行動(聖杯牌組的行動力偏弱)。\n\n\
    ...
    躲起來一下，暫停，免於外界的紛紛擾擾，處於暫時休戰的狀態，躲避戰爭，休息困頓的身軀，也代表著當事人已疲累，\
    被各種想法操煩到疲累，需要調養，是一種停止的狀況，為的是面對接下來戰場的挑戰，代表有相當棘手的情況可能發生，\
    需要謹慎的思慮以面對。\n\n\
    感情方面，兩人或許有爭執，然而雙方對於彼此的爭執已生厭倦，雙方想要停下來獨自一人思考沉澱，\
    又或是兩人之間的相處疲累，雙方都倦了。\n\n\
    ...
    也是代表金錢不斷的產生，收入不斷的增加，而手、頭部與腳步都要持有錢幣，牢牢地抓住金錢，是一種封閉的姿勢，\
    也就是說，他的錢是只進不出的，財富不斷的累積，不斷的增長，儲蓄是他的理財觀點，記帳是他必備的技能，\
    對於他人來說是節省，也是一種小氣，斤斤計較或許可以用來描述這一個人的個性。\n\n\
    在感情狀況主打保守牌，小心翼翼的謹慎態度為原則，兩人之間相處狀況拘謹，安全是兩人相處的最佳默契，並且以金錢觀來說，\
    ...
    沒有一個人可以扳倒對方，其場景可能是在開會之時的熱烈狀況，激烈的言語，感覺起來整個亂糟糟的狀況，\
    大家都想要獲得最佳的利益，再持續糟糕的話或許火元素與棍棒的作用下就要打起來了。\n\n\
    ...
    心中充滿五味陳雜，複雜的情緒，遠方的橋與房子，象徵的是需要來自社會的關心關懷，需要當事人環境的支持與照顧，\
    陪他走過哀傷的階段，而在這張牌出現時，可以看到圖中的人物身後仍有兩個未倒掉的杯子，\
    他並非一無所有，只是他選擇不去碰觸，漠視了這些，選擇讓自我沉浸於低迷的氣氛，擴大眼前的失落，只看事物的黑暗層面。\n\n\
    ...
    在這裡描述的場景是爭辯之後的慘烈勝利，贏得了賽局卻失去了關係，詭辯或許是常用的伎倆，來陰的，\
    ...
    但是有錢的對象卻不是前方兩個人，前景的瘸子與流浪者正處於飢寒交迫的狀態，尋找庇護的地方，在實際的場景或許是在尋找金援，\
    雖然兩人之間都存在個貧窮寒冷的狀態，然而也是因為彼此需要照顧，兩人的困境把他們聯繫了起來，在風雪當中前進，\
    面對共同的敵人，嚴寒與飢餓，故有一種患難見真情的關係存在，在感情中出現這張牌，或許經濟的條件雖然不是很好，\
    ...
    重新領導大家，往共同的目標前進，大家是讚同與支持這位騎士的，得到眾人的誇耀與高評價，而騎士的權杖比他人要高，\
    ...
    過去曾經美好的感受與感覺；在牌面左方有個侍衛守護道路，表示並不想要有人來打擾這段回憶，當事人或許耽溺於過去美好的回憶當中，\
    若當事人從悲傷的聖杯五走來，或許需要一些美好過去與他人的經驗，還有當下對於單純人際上關懷的需要，\
    來度過哀傷時期，沒有需要懂得人情世故的關係，來自他者無條件的關懷可以撫平混亂悲傷的感受。\n\n\
    ...
    由水面來看，這船划得相當的緩慢，船夫僅是緩慢的撐竿前進，在水面泛起漣漪，表示當前的狀況必須和緩的前進，需要慢慢來，\
    而前面的寶劍直立束在前方，除了感到沉重之外，也表示其實這理前進的方向是有想法有規劃，有步驟的，正位表示雖然緩慢，\
    但仍可以順利到達彼岸；而因此牌有一端順利到達一端的訊息存在，是有利溝通層面的，\
    種種的矛盾與誤解可以緩慢得透過溝通的方式得以解決。\n\n\
    ...
    一點點的喜悅之感；錢幣六當中的施予者，從後方的城堡出來，代替主人來施賞財務，接濟貧困，在抽到這組牌的時候，\
    表示當事人是有實力的，有經濟資源與財富，而其態度是樂善好施，慷慨的大善人，另外一方面，\
    這份施捨並非是胡亂給予，圖中的施予者手一端手握有秤秤，他是經過衡量受施者的財富狀況而進行給予的，\
    ...
    面對當前的眾多挑戰，主動勇敢承擔，萬夫莫敵，發揮他手中的能力與資源，努力解決，最終獲得當前的突破，在眼前的挑戰，\
    可以視為其他的競爭者，也可以是個案自己給自己立下的挑戰，比如多重的事件任務、工作計畫，這些人、\
    ...
    各種內心的渴望無法在現實世界中滿足被壓抑而在夜晚的夢境中洩漏出來，面對各種的渴望，\
    圖中的當事人面對這些光彩耀目的慾望，顯得感覺沉醉，也被眼前這些吸引的無法逃脫，雖然名為夢境的一張牌，\
    但是此牌的狀態也常出現在真實的世界當中，個案看起來像是沉醉在幻覺，把一切的事情想得美好，與現實脫鉤，不是真的。\n\n\
    ...
    對於圖中的人物而言，他是挺而走險的，弄得不好便被敵方抓住，造成傷害，然而正位之時，\
    技巧高明的他順利的取走利劍而沒有被察覺，也代表謀略成功，是高明的點子，精心的設計，絕妙的心機，\
    絕到好處的時機，具有刺激的快感。\n\n\
    在感情的層面，出現寶劍七往往不單純，感情需要用到計謀與謀略顯然雙方的關係有很多無法輕易碰觸的層面，\
    檯面下的規矩規則很多，無法直接表達與說出口的話語，需要用間接性的溝通方式，另一方面也有可能做出對不起對方的事情，欺騙對方。\n\n\
    ...
    已經採收了一顆錢幣，他正在思所以經摘下這顆錢幣之後，要如何去投注自己的土地，去產生更多的錢幣，\
    所以在錢幣七當中的人物，是不斷的在思索著下一步的，場景有如已經賺了一小筆錢，要如何將這一筆小小的財富換取更大的收穫，\
    以產生財生財、錢滾錢，而從他的眼神來看，他是謹慎專注的，深思熟慮。\n\n\
    在感情當中出現錢幣七，或許兩人為了金錢或是實際的生活而忙碌，有可能兩個人是以未來更好的將來追求而結合在一起，\
    也有可能兩人之間心不在感情上，而在實際的事務當中忙碌著，而錢幣七有投資報酬的特性，\
    ...
    也隱含的是行動力與方向的一致，快速有效，能量極強，而另一方面，權杖八是射出的箭，所以也有遠行的涵義於其中。\n\n\
    ...
    雖然一切好像沒有什麼重大缺點，但就是太過無趣，想要去一個地方改變改變，尋求新的感情上的波動，然而這份追尋或許不會太久，\
    又或者只是想一想而已，畢竟當前的狀態雖然不滿意，但是是可以接受的，沼澤之地也象徵的是這份尋找的力量不會太遠，\
    或許只是上陽臺吹吹風感嘆一下而已。\n\n\
    ...
    透過地上的水痕，感受自己心中的感受，想辦法脫困，旁邊的這些利劍，可能是來自他人的一些建議，或是自己心中的想法、\
    評價，然而這些想法、意見、建議，確確讓他更加的受困於其中，陷入一種僵持的局面當中，處於困擾的情緒，\
    不知道什麼是正確的方向，只能稍稍的加以摸索，卻害怕受到傷害，表現的相當無力感，害怕與退縮。\n\n\
    ...
    所以他的金錢收入不像是錢幣七那樣是需要靠外在環境投資的方式，而是有作即有收入，比較像是現在社會上的受雇者，\
    能力與勞力付出多少便可以的到多少，是一份穩定的工作，不過因為工作的內容與收益是穩定的，所以也少了一份對於未來的想望，\
    只是專注於當下手上的工，把它做好做滿。\n\n\
    感情上，雙方可能照表操課，就像是把感情當排定好的工作一樣，依靠行事曆式的規劃而生活，\
    ...
    經歷過數場戰鬥，負傷而歸的他正在城中採取防守姿態，打持久戰，是故目前情勢看起來遭受到了受困孤立的狀態，\
    正在等待援助的到來，目前在做最後的堅持，守護最後的一道防線，就實際的面向上來看，可能出現了眾多紛擾的工作，\
    ...
    與權杖七相較，似乎都有面臨挑戰的味道，且兩者來說，逆位也皆有潰敗逃跑之意，然差別在於權杖九是攻城戰，\
    ...
    對於自己相當得滿意，過去的種種經驗對他而言的過程一切都充滿了意義，開心是他此刻的心情；\
    而此場景也可以想像是開會的局面，每個杯子後方皆是一位與會者，對於眼前的這位人物給予最大的讚美與讚賞，\
    交流方面亦是和諧滿足。\n\n\
    ...
    不想承受面對這些，這些可能是過去的秘密、過去經驗的傷害或者是他人的背叛，最為不想遭遇到的傷痛經驗，極度的身心上的創傷壓力，\
    驚恐與恐慌。\n\n\
    ...
    金錢物質上的無虞是錢幣九的內容，然而不一定人人都是適合這樣的享受生活，畢竟沒有目標的日子有人是待不下去的，\
    貴婦手中的鳥或許是他的心情寫照，鳥兒本應在天上飛，承著風的飛翔，如今卻被眷養於手掌隻中，雖然被照顧得很好，\
    ...
    獨自面對承擔這項任務，而城堡似乎離她還很遠，離達陣還有一段距離，所以這樣的狀況，他舉步維艱，\
    每一步都走的不容易，身負巨大壓力，未來雖然可以達到成功的城堡，但是過程的困難程度令人難以想像；\
    像是在職場上，同時承接太多任務，有可能是人手不足的狀況所導致的，不過權杖十的人物任勞任怨，\
    只是埋頭苦幹，沒有任何的怨言。\n\n\
    ...
    發現到分享會讓這份快樂更加的擴大與延續，聖杯十講的是關係上的和諧滿足，形成同盟性質的團隊關係，對於未來保持希望。\n\n\
    ...
    但終究是個結束，過程雖然痛苦，但也是一種解脫，圖片手中的手勢，與教皇排的手勢相當，或許留下了一個伏筆，\
    可能藉著宗教的力量希望尋求救贖，來世可以好過一點，又或者是可能死前有經歷過垂死掙扎，但等不到救援，\
    感受到最深的無望，毫無轉機，最終的命運仍就是終結；寶劍十可能是流言蜚語無法辯解，百口莫辯，無法翻身，\
    也有可能是做錯事情，遭受批判沒有給予悔改挽回的機會。\n\n\
    ...
    金錢事業上的成功與穩定，錢幣後方繪製的是家庭，而且是三代同堂的傳統家庭，圖中有一守衛守住大門，\
    也象徵了安全感的空間，若是以現代社會來講，錢幣十所代表的是家族產業，且正位的是家族和諧的家族事業，\
    具有百年商號的大型公司，在人際上，因為錢幣十延伸了三個世代的人物，所以出現錢幣十往往也與家庭中的長輩有關係，\
    在正位之時，所作所為是得到家中老長輩的支持的，且家庭提供資源資金。\n\n\
    在感情中出現錢幣十，雖然關係如同一家人間的緊密，但錢幣元素這張顯的太過於穩定，可能平淡無趣。\n\n\
...
if __name__ == '__main__':
    main()
##    res = "查塔羅說明0"
##    if re.search("查(塔羅牌|塔羅|tarot)說明(\d+)",res):
##        card_id = re.search("查(塔羅牌|塔羅|tarot)說明(\d+)",res).group(2)
##        print(card_id)
##        print (tarot_detail(int(card_id))
##        #content = tarot_random()
##    else:
##        print("NO")
