...
class start_talk(object):
    ...
    def star_talk(self, messages_talk, user_name):
        ...
        if re.search("小星星",messages_talk):
            ...
            if re.search("[虧撩](妹|你|妳|我|咩|妹妹|姐姐)",messages_talk):
                return self.talk_dict('bamai',user_name)
            ...
            if re.search("是辭海",messages_talk):
                return self.talk_dict('辭海',user_name)
    ...
    def talk_dict(self,res,u):
        dict={
                ...
                'good':['別那麼說啦~我還差得遠呢?','一級棒棒一級棒　一級棒棒一級棒','妳也很棒啊','還差星爸很多啦','我會更努力的~','沒有啦~還很多要學呢?',
                        '我也給妳一個讚','有什麼不好的地方要跟我說哦','ε٩(๑> ₃ <)۶з','ξ( ✿＞◡❛)'],
                ...
                '可愛':['謝謝妳','妳也很可愛啊','這樣可愛嗎?','害羞~~~','妳比較可愛啦','ε٩(๑> ₃ <)۶з'],
